...
public class HttpHelper {
	...
	public void doGetNotReturn(String url) throws IOException {
	...
	private void doPostNotReturn(String url,HttpEntity entity) throws ClientProtocolException, IOException{
		HttpPost httpPost = new HttpPost(url);
		httpPost.addHeader("Content-Type","application/json; charset=UTF-8");
		httpPost.setEntity(entity);
